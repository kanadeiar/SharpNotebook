...
Запуск множества асинхронных операций может быть произведено одновременно и одновременно можно получить результаты от операций:
...
Можно обрабатывать задачи по мере поступления решения от каждой задачи:
