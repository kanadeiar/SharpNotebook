...
При построении выражений запросов делагаты Func<> и вызовы расширяющих методов Enumerable остаются вне поля зрения и внимания, т.к. ими занимается компилятор C#. Создание выражений LINQ с примененением различных операций запросов являетя наиболее распространенным и простым подходом.
