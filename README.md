...
х [* NET5 WPF MVVM Инфраструктура](./windows/indexNET5MVVMInfrastructure.md).

х [* NET5 WPF MVVM Примеры](./windows/indexNET5MVVMSample.md).
...
x [* NET5 EF Core 5](./sql/indexEFCore5.md).
