...
Конструкторы класса не наследуются. Если конструктор явно в классе не задать, то компилятор создаст неявный конструктор без параметров по умолчанию. Если создать конструктор с параметрами, но неявный конструктор без параметров станет недоступен.
