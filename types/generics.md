...
Основным ограничением может быть ссылочный тип, указывающий на незапечатанный класс. Это ограничение, что заданный аргумент-тип будет относится либо к типу, указанному в ограничении, либо к производному от него типу.
...
Есть ограничение параметра типа, позволяющее задать обобщенному типу или методу, что аргумент-типы должны быть связаны отношениями. К параметру-типу может быть примененно ноль и более ограничений.
